...
$string['bbbclassroom'] = 'Virtual classrooms';
$string['addbbbclassroom'] = 'Enable rooms';
$string['addbbbcalendarevent'] = 'Add link to room in calendar';
$string['accessbbbroom'] = 'Enter room';
...
$string['bbbclassroom_help'] = 'Add a BigBlueButton virtual classroom to appointment sessions';
...
$string['bbbroomfor'] = '{$a} virtual classroom';
...
$string['error:bbbroomnotenabled'] = 'Rooms are not enabled for this activity.';
